...
<style type="text/css">
 ...
 <div class="container" >
 	<audio width="100%" controls>
		  <source src="<?php echo web_root.'admin/modules/lesson/'.$res->FileLocation; ?>" type="audio/mp3">
		  <source src="<?php echo web_root.'admin/modules/lesson/'.$res->FileLocation; ?>" type="audio/wav"> 
		</audio>
