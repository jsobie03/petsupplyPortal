...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "www.jonsobier.com", "port" => 3306, "user" => "jsobieze_psPort", "pass" => "adminPS", "db" => "jsobieze_psportal", "qs" => "`", "qe" => "`");
...
define("EW_SENDER_EMAIL", "jonsobier@outlook.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "jonsobier@outlook.com", TRUE); // Recipient email address
...
define("MS_AUTO_LOGOUT_AFTER_IDLE_IN_MINUTES", 120, TRUE); // get from project setting since v12 = 120 minutes!
