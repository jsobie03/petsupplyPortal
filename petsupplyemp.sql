...
--
-- Host: 127.0.0.1    Database: petsupply
-- ------------------------------------------------------
...
INSERT INTO `employees` VALUES (1,'Pet Supply','Freehafer','Nancy','nancy@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 1st Avenue','Seattle','WA','99999','USA','#http://northwindtraders.com#',NULL,'','Freehafer1','password'),(2,'Pet Supply','Cencini','Andrew','andrew@northwindtraders.com','Vice President, Sales','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 2nd Avenue','Bellevue','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales.','','Cencini2','password'),(3,'Pet Supply','Kotas','Jan','jan@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 3rd Avenue','Redmond','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Was hired as a sales associate and was promoted to sales representative.','','Kotas3','password'),(4,'Pet Supply','Sergienko','Mariya','mariya@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 4th Avenue','Kirkland','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#',NULL,'','Sergienko4','password'),(5,'Pet Supply','Thorpe','Steven','steven@northwindtraders.com','Sales Manager','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 5th Avenue','Seattle','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Joined the company as a sales representative and was promoted to sales manager.  Fluent in French.','','Thorpe5','password'),(6,'Pet Supply','Neipper','Michael','michael@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 6th Avenue','Redmond','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Fluent in Japanese and can read and write French, Portuguese, and Spanish.','','Neipper6','password'),(7,'Pet Supply','Zare','Robert','robert@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 7th Avenue','Seattle','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#',NULL,'','Zare7','password'),(8,'Pet Supply','Giussani','Laura','laura@northwindtraders.com','Sales Coordinator','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 8th Avenue','Redmond','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Reads and writes French.','','Giussani8','password'),(9,'Pet Supply','Hellung-Larsen','Anne','anne@northwindtraders.com','Sales Representative','(123)555-0100','(123)555-0102',NULL,'(123)555-0103','123 9th Avenue','Seattle','WA','99999','USA','http://northwindtraders.com#http://northwindtraders.com/#','Fluent in French and German.','','Hellung-Larsen9','password'),(10,'Pet Supply','Sobier','Jonathan','jonspetsupply@gmail.com','Full Time Associate','(949)713-5565','(949)690-1553',NULL,NULL,'32782 Meadowpark Lane','Trabuco Canyon','CA','92679','USA','http://www.jonsobier.com','Hard Working and Dedicated',NULL,'jsobie03','admin');
...
INSERT INTO `orders` VALUES (1,'VSI','Michelle','jsobie03','MPP Hunters',6,6,'2019-02-13'),(2,'UPP','Mariel','jsobie03','Farmina ND Dig Lamb 27lbs',6,0,'2019-02-13'),(3,'Newco','Clinton','jsobie03','Smallbatch Bulk Turkey',8,8,'2019-02-13');
...
CREATE TABLE `products` (
  ...
  `ProductProtein` varchar(255) NOT NULL,
...
INSERT INTO `products` VALUES (1,'Zignature','Turkey','27lbs',5,60,60,65,5),(2,'Google Chromebooks','1','Google Chromebooks- 1.0',100,75,654,-479,20),(3,'Cisco Router','10X','Cisco Router- 10X',45,143,76,86,88),(4,'sadasd','21','sadasd- 21',25,0,0,25,10),(5,'Semih','37','Semih- 37',1,12,5,8,5),(6,'crazy horse router','123DF5','crazy horse router- 123DF5',5,23,0,28,1),(7,'Monitors','','Monitors - 999',0,0,0,0,0),(8,'TEST','123','TEST- 123',10,0,0,10,10),(9,'bob','bob-1','bob- bob-1',500,412,267,6450,400),(10,'Multimeter','c345','Multimeter- c345',3,28,29,2,4),(11,'dfgdf','54334','dfgdf- 54334',0,0,300,-300,0),(12,'UniBox','1','UniBox- 1',200,0,0,200,300),(13,'Test 1','123456','Test 1- 123456',50,1234,0,1284,10),(14,'Toby','57456','Toby- 57456',567,22,12,577,56467),(15,'sdsad','sdsdsad','sdsad- sdsdsad',12,0,0,12,12),(16,'test','55555','test- 55555',500,12,0,512,25),(17,'Firewalls','362436','Firewalls- 362436',5,33,900,-862,10),(18,'Cables','7734','Cables- 7734',9,475,9000,16,100),(19,'Test','1','Test- 001',25,0,0,25,222);
...
INSERT INTO `suppliers` VALUES (1,'Newco'),(2,'ASC'),(3,'Central'),(4,'UPP'),(5,'Pets Global'),(6,'VSI'),(7,'Cal Cricket Ranch'),(8,'Phillips'),(9,'Hagen'),(10,'Halshan');
/*!40000 ALTER TABLE `suppliers` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'petsupply'
--

--
-- Dumping routines for database 'petsupply'
--
...
-- Dump completed on 2019-02-13 12:12:08
