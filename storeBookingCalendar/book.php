...
//	if(empty($errors))
	{
		...
		$repname = htmlspecialchars($_POST["repname"]);
		...
		$sql = "INSERT INTO $tablename (brandname, repname, phone, item, start_day, start_time, end_day, end_time, canceled)
			VALUES ('$brandname', '$repname', '$phone', '$item', $start_day, $start_time, $end_day, $end_time, 0)";
...
<a href="index.php"><p>Return To The Booking Calendar</p></a>
